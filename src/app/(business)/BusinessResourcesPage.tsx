...
const BusinessResourcesPage: React.FC = () => {
  ...
  const exportCsv = () => {
    ...
    link.href = url;
    link.download = `business-resource-transparency-${tab.toLowerCase().replaceAll(" ", "-")}.csv`;
    link.click();
    URL.revokeObjectURL(url);
  };

  return (
    <DashboardShell portal="business" title="Business Resource Transparency">
