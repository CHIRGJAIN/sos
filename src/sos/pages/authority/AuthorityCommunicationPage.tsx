...
const AuthorityCommunicationPage = () => {
  ...
  return (
    <div className="space-y-4">
      <SectionTitle title="Communication Center" subtitle="Authority to NGO and team coordination threads" />
...
export default AuthorityCommunicationPage;
